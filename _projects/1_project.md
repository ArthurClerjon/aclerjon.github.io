...
![Répartition énergie par source](assets/img/Sankey/Itese_Visual(1).png)
...
![Consommation par secteur](assets/img/Sankey/Itese_Visual(2).png)
...
![PAC - Scénario 50%](assets/img/Sankey/Itese_Visual(3).png)
...
La valorisation de cette chaleur fatale pourrait subvenir au besoin de chauffage et ![Potentiel de chaleur fatale](assets/img/Sankey/Itese_Visual(4).png)

ce potentiel est comparé au besoin 2019 et celui  du scénario ‘50% PAC’ sur le visuel suivant.
...
Le couple batterie - moteur électrique  : u​n fort gain d'efficacité énergétique
...
![Effets VE sur le transport](assets/img/Sankey/Itese_Visual(5b).png)
...
### 2.c - Bilan : effet global de ces scénarios de développement technologique

Évaluons maintenant l’effet cumulé que pourrait avoir le déploiement de ces deux  technologies – pompes à chaleur et véhicules électriques – sur la consommation globale d’énergie finale (hors transport international et consommations à usages non-énergétiques). ![Effet global des scénarios](assets/img/Sankey/Itese_Visual(7).png)

Les résultats sont présentés sur la figure ci-dessous. Rappelons toutefois qu’il ne s’agit là que de scénarios d’électrification choisis arbitrairement et non pas de potentiels maximum​.
...
### 2.d - Quels leviers supplémentaires pour décarboner la consommation d'énergie ?
